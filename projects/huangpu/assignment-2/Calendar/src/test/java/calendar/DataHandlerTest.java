...
public class DataHandlerTest{
  ...
  public void setUp() {
      ...
      testfile.delete();
      testfile = new File("new_test.xml");
      testfile.delete();
  }
  ...
  public void test01()  throws Throwable  {
      ...
      day0.addAppt(appt0);
      DataHandler data1 = new DataHandler("test.xml");
  ...
  public void test02()  throws Throwable  {
      ...
      Appt appt0 = new Appt(5, 6, 7, 8, 2018, "nothing", "is special but a meeting", "huang@gmail.com");
      day0.addAppt(appt0);
      DataHandler data0 = new DataHandler("test.xml", false);
  ...
  public void test03()  throws Throwable  {
      ...
      day0.addAppt(appt0);
      DataHandler data0 = new DataHandler("test.xml");
  ...
  public void test04()  throws Throwable  {
      ...
      day0.addAppt(appt0);
      DataHandler data0;
      data0= new DataHandler("test.xml");
    ...
    public void test05()  throws Throwable  {
        ...
        day0.addAppt(appt0);
        DataHandler data0;
        data0= new DataHandler("test.xml", false);
        data0.saveAppt(appt0);
        assertTrue(data0.deleteAppt(appt0));
        Appt appt1 = new Appt(5, 6, 7, 8, 2018, "Meeting", "This is a meeting", "huang@gmail.com");
        day0.addAppt(appt0);
        DataHandler data1 = new DataHandler("test.xml", false);
