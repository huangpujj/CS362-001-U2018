...
public void test08()  throws Throwable  {
    Appt appt = new Appt(8, 8, 8, -100, 2600, "Nothing", "is important", "than breakfast");
    appt.setValid();
    String string0 = appt.toString();
    assertFalse(appt.getValid());
    Appt appt0 = new Appt(8, 8, 8, 1, 2600, "Nothing", "is important", "than breakfast");
    appt0.setValid();
    assertTrue(appt0.getValid());
    	
    Appt appt1 = new Appt(8, 8, 8, 12, 2600, "Nothing", "is important", "than breakfast");
    appt1.setValid();
...
public void test20() throws Throwable{
	Appt appt = new Appt(0, 10, 8, 1, 2020, "Nothing", "is important", "than breakfast");
    appt.setValid();
    assertTrue(appt.getValid());
    Appt appt1 = new Appt(5, 0, 8, 1, 2020, "Nothing", "is important", "than breakfast");
    appt1.setValid();
    assertTrue(appt1.getValid());
}
...
public void test21() throws Throwable{
	Appt appt = new Appt(23, 34, 8, 8, 2600, "Nothing", "is important", "than breakfast");
    appt.setValid();
    assertTrue(appt.getValid());
    Appt appt1 = new Appt(5, 59, 8, 1, 2020, "Nothing", "is important", "than breakfast");
    appt1.setValid();
    assertTrue(appt1.getValid());
}
...
public void test22() throws Throwable{
	...
	Appt appt = new Appt(8, 8, 8, 8, 0, "Nothing", "is important", "than breakfast");
    appt.setValid();
    assertFalse(appt.getValid());
...
@Test(timeout = 4000)
public void test23() {
	 Appt appt1 = new Appt(5, 10, 31, 8, 2020, "Nothing", "is important", "than breakfast");
	    appt1.setValid();
	    assertTrue(appt1.getValid());
}
...
public void test24() {
	Appt appt2 = new Appt(5, 10, 1, 8, 2020, "Nothing", "is important", "than breakfast");
    appt2.setValid();
